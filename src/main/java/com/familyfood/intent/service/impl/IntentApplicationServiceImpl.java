package com.familyfood.intent.service.impl;
...
public class IntentApplicationServiceImpl implements IntentApplicationService {
    ...
    @Autowired
    public IntentApplicationServiceImpl(ActorContextProvider actorProvider, IntentRequestMapper intentMapper,
