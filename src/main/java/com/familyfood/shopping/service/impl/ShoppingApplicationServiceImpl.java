...
public class ShoppingApplicationServiceImpl implements ShoppingApplicationService {
    private final ActorContextProvider actorProvider;
    private final ShoppingListService shoppingListService;

    @Autowired
    public ShoppingApplicationServiceImpl(ActorContextProvider actorProvider, ShoppingListService shoppingListService) {
