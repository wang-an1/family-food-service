...
public class SystemConfigService implements SystemConfigApi {
    private final SystemConfigMapper configMapper;
    private final ActorContextProvider actorProvider;

    public SystemConfigService(SystemConfigMapper configMapper, ActorContextProvider actorProvider) {
